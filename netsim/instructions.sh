...
cd ~ && git clone https://github.com/ipspace/netsim-tools.git
...
cd ~ && git clone https://github.com/ipspace/netsim-examples.git && cd netsim-examples/BGP/IGP-metric/
...
cd ~ && git clone https://github.com/ipspace/netsim-examples.git && cd netsim-examples/routing/failover/
export PATH=/home/iason/netsim-tools:$PATH
